...
class DLLObjectivesFragment : Fragment() {
    ...
    // 1. Data Storage
    private var objectivesData = linkedMapOf(
        "Content Standard" to "The learner demonstrates understanding of key concepts...",
        "Performance Standard" to "The learner is able to formulate and solve problems...",
        "Learning Competencies" to "Illustrates polynomial functions."
    )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 3. Edit Click Listener
        btnEdit.setOnClickListener {
            val intent = Intent(requireContext(), DLLEditActivity::class.java).apply {
                putExtra(DLLEditActivity.EXTRA_SECTION_TITLE, "Edit Objectives")
                putExtra(DLLEditActivity.EXTRA_DATA_MAP, HashMap(objectivesData))
            }
